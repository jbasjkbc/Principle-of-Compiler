...
let rec decomp ints : instr list = 
    ...
    | CODEPRINTCH :: ints_rest                         ->   PRINTCH        :: decomp ints_rest
    ...
    | CODECSTC   :: c :: ints_rest                    ->   CSTC c :: decomp ints_rest       
